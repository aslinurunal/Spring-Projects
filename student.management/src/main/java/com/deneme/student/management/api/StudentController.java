package com.deneme.student.management.api;
...
public class StudentController {
	...
	public ResponseEntity<Student> update(@PathVariable Integer id, @RequestBody final StudentDTO dto) throws StudentNotFoundException {
	...
	public ResponseEntity<Integer> delete(@PathVariable Integer id) throws StudentNotFoundException {
		Student existingStudent = service.getStudentById(id);
